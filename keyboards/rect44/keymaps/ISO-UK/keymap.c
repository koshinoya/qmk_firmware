...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT(
        ...
        KC_LCTL,        KC_LGUI,         KC_LALT, LT(_FN1,KC_SPC),  KC_NO,   RSFT_T(KC_SPC),   KC_RALT, MO(_FN2), KC_LEFT, KC_DOWN, KC_RGHT
    ),
    [_FN1] = LAYOUT(
    ...
    [_FN2] = LAYOUT(
        KC_NO,          RGB_TOG,         RGB_HUI, RGB_SAI, RGB_VAI, KC_NO,   KC_NO,   KC_NO,   KC_INS,  KC_PSCR,  KC_SLCK, KC_PAUS, KC_NO,
        ...
        KC_TRNS,        KC_TRNS,         KC_TRNS, KC_TRNS,          KC_NO,   KC_TRNS,          KC_TRNS, KC_TRNS,  KC_NO,   KC_NO,   KC_NO
    )
};
